...
def run_test_drive_system():
    ...
    run_test_go_straight_for_inches(robot)    # import for the final step - Last one done in class
    # run_test_spin_in_place_for_seconds(robot)
    # run_test_spin_in_place_for_degrees(robot) # import for the final step
    # run_test_turn_for_seconds(robot)  # I'd probably skip this one
    # run_test_turn_for_degrees(robot)  # I'd probably skip this one
    # run_test_draw_polygon(robot)


def run_test_go_stop(robot: rosebot.RoseBot):
    """
...
def run_test_go_straight_for_seconds(robot: rosebot.RoseBot):
    """
    ...
    while True:
        ...
        # -------------------------------------------------------------------------
        robot.drive_system.go_straight_for_seconds(speed, seconds)


def run_test_go_straight_for_inches(robot: rosebot.RoseBot):
    """
    ...
    while True:
        ...
        # -------------------------------------------------------------------------
        robot.drive_system.go_straight_for_inches(speed, inches)
