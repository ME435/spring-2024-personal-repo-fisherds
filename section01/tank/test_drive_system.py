...
def run_test_drive_system():
    ...
    run_test_go_straight_for_inches(robot)  # important - last one together
    # run_test_spin_in_place_for_seconds(robot)
    # run_test_spin_in_place_for_degrees(robot)  # I would use this one.
    # run_test_turn_for_seconds(robot) # unusued - SKIP
    # run_test_turn_for_degrees(robot) # unusued - SKIP
